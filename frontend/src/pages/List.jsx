...
export default function ContainerResponsive() {
   ...
   */
  return (
    <main className="flex justify-center flex-wrap w-full gap-6 flex-column">
      <h3 className="p-5 h-5 text-center">
        Available vehicle(s) in {whereInput} for the {dateFormated}:
      </h3>
      <div className="flex justify-center flex-wrap w-full gap-6 flex-column">
        {vehicles
          ?.filter(
